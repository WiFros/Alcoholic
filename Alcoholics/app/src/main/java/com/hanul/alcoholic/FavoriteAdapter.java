...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.CustomViewHolder> {
    ...
    private String uid;
    private int pos;
    public FavoriteAdapter(ArrayList<Comment> arrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, int position) {
        holder.favorite_body.setText(arrayList.get(position).getBody());
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        TextView favorite_body;
        public CustomViewHolder(@NonNull View itemView) {
            super(itemView);
            this.favorite_body = itemView.findViewById(R.id.favorite_body);
        }
    }
}
